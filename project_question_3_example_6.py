...
P_5: np.ndarray = calculate_probability(MOUSE_MOVEMENT_TRANSITION_MATRIX, 5)
P_10: np.ndarray = calculate_probability(MOUSE_MOVEMENT_TRANSITION_MATRIX, 10)
P_15: np.ndarray = calculate_probability(MOUSE_MOVEMENT_TRANSITION_MATRIX, 15)
...
matrices: list[np.ndarray] = [
    calculate_probability(MOUSE_MOVEMENT_TRANSITION_MATRIX, x)
